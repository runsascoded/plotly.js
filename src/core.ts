...
if(typeof window !== 'undefined' && (window as any).PlotlyLocales && Array.isArray((window as any).PlotlyLocales)) {
    register((window as any).PlotlyLocales);
    delete (window as any).PlotlyLocales;
}
