...
export var id2name = function id2name(id) {
...
export var name2id = function name2id(name) {
...
export var cleanId = function cleanId(id, axLetter, domainId) {
...
export var list = function(gd, axLetter, only2d) {
...
export var listIds = function(gd, axLetter) {
    var fullLayout = gd._fullLayout;
    if(!fullLayout) return [];
...
export var getFromId = function(gd, id, type) {
    var fullLayout = gd._fullLayout;
...
export var getFromTrace = function(gd, fullTrace, type) {
    var fullLayout = gd._fullLayout;
    var ax = null;
...
export var idSort = function(id1, id2) {
...
export var isLinked = function(fullLayout, axId) {
    return (
