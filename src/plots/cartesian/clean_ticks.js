...
export function dtick(dtick, axType) {
...
export function tick0(tick0, axType, calendar, dtick) {
    if (axType === 'date') {
        return cleanDate(tick0, dateTick0(calendar, (dtick % ONEWEEK === 0) ? 1 : 0));
    }
