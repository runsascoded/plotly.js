...
export function initInteractions(gd) {
    ...
    if (!fullLayout._has('cartesian') && !fullLayout._has('splom'))
        return;
    ...
    subplots.forEach((subplot) => {
        ...
        if (!plotinfo.mainplot) {
            ...
            const maindrag = makeDragBox(gd, plotinfo, xa._offset, ya._offset, xa._length, ya._length, 'ns', 'ew');
    ...
    const hoverLayer = fullLayout._hoverlayer.node();
