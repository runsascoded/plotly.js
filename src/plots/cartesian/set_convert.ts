...
export default function setConvert(ax?: any, fullLayout?: any): any {
     ...
     */
    function dt2ms(v?: any, _?: any, calendar?: any, opts?: any) {
    ...
    function ms2dt(v?: any, r?: any, calendar?: any) {
        return ms2DateTime(v, r, calendar || ax.calendar);
    }

    function getCategoryName(v?: any) {
     ...
     */
    function setCategoryIndex(v?: any) {
    ...
    function getCategoryIndex(v?: any) {
    ...
    function getRangePosition(v?: any) {
        return isNumeric(v) ? +v : getCategoryIndex(v);
    }

    // include 2 fractional digits on pixel, for PDF zooming etc
    function _l2p(v?: any, m?: any, b?: any) { return d3Round(b + m * v, 2); }
    ...
    if(['linear', '-'].indexOf(ax.type) !== -1) {
        ...
        ax.d2p = ax.r2p = function(v?: any) { return ax.l2p(cleanNumber(v)); };
        ax.p2d = ax.p2r = p2l;

        ax.cleanPos = ensureNumber;
    } else if(ax.type === 'log') {
        // d and c are data vals, r and l are logged (but d and r need cleaning)
        ax.d2r = ax.d2l = function(v?: any, clip?: any) { return toLog(cleanNumber(v), clip); };
        ax.r2d = ax.r2c = function(v?: any) { return fromLog(cleanNumber(v)); };
        ...
        ax.d2p = function(v?: any, clip?: any) { return ax.l2p(ax.d2r(v, clip)); };
        ax.p2d = function(px?: any) { return fromLog(p2l(px)); };

        ax.r2p = function(v?: any) { return ax.l2p(cleanNumber(v)); };
        ax.p2r = p2l;
        ...
        ax.d2p = ax.r2p = function(v?: any, _?: any, calendar?: any) { return ax.l2p(dt2ms(v, 0, calendar)); };
        ax.p2d = ax.p2r = function(px?: any, r?: any, calendar?: any) { return ms2dt(p2l(px), r, calendar); };

        ax.cleanPos = function(v?: any) { return cleanDate(v, BADNUM, ax.calendar); };
        ...
        ax.d2p = function(v?: any) { return ax.l2p(ax.r2c(v)); };
        ax.p2d = function(px?: any) { return getCategoryName(p2l(px)); };
        ax.r2p = ax.d2p;
        ax.p2r = p2l;

        ax.cleanPos = function(v?: any) {
     ...
     */
    ax.cleanRange = function(rangeAttr?: any, opts?: any) {
        ax._cleanRange(rangeAttr, opts);
        ax.limitRange(rangeAttr);
    };

    ax._cleanRange = function(rangeAttr?: any, opts?: any) {
        if(!opts) opts = {};
        if(!rangeAttr) rangeAttr = 'range';
    ...
    ax.isValidRange = function(range?: any, nullOk?: any) {
        return (
            Array.isArray(range) &&
            range.length === 2 &&
