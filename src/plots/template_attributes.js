...
export const hovertemplateAttrs = ({ editType = 'none', arrayOk } = {}, extra = {}) => ({
    valType: 'string',
    dflt: '',
    editType,
    description: [
...
export const texttemplateAttrs = ({ editType = 'calc', arrayOk } = {}, extra = {}) => ({
    valType: 'string',
    dflt: '',
    editType,
    description: [
...
export const shapeTexttemplateAttrs = ({ editType = 'arraydraw', newshape } = {}, extra = {}) => ({
    valType: 'string',
    dflt: '',
    editType,
    description: [
