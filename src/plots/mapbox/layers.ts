...
function MapboxLayer(this: any, subplot: any, index: any) {
...
proto.findFollowingMapboxLayerId = function(below: any) {
    if(below === 'traces') {
...
export default function createMapboxLayer(subplot: any, index: any, opts: any) {
    // @ts-ignore TS7009
    const mapboxLayer: any = (new MapboxLayer(subplot, index) as any);
