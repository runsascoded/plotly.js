...
attributes.type.values = (allTypes as any);
...
export function redrawText(gd?: any): any {
    gd = getGraphDiv(gd);
...
function emptySubplotLists(): any {
    let collectableSubplotTypes: any[] | null = _collectableSubplotTypes;
    const out: any = {};
    let i, j;
 ...
 */
function getFormatter(formatObj?: any, separators?: any): any {
...
export function _hasPlotType(this: any, category?: any): boolean {
    ...
    for(i = 0; i < modules.length; i++) {
        ...
        const _module: any = registryModules[name];
...
export function clearExpandedTraceDefaultColors(trace?: any): void {
    ...
    function locateColorAttrs(attr?: any, attrName?: any, attrs?: any, level?: any) {
        path[level] = attrName;
        path.length = level + 1;
...
export function supplyDataDefaults(dataIn: any, dataOut: FullTrace[], layout: any, fullLayout: FullLayout): any {
    ...
    function pushModule(fullTrace?: any) {
        ...
        if(fullTrace.visible === true) pushUnique(visibleModules, _module);
...
export function supplyTraceDefaults(traceIn?: any, traceOut?: any, colorIndex?: any, layout?: any, traceInIndex?: any): any {
    ...
    const _module: any = getModule(traceOut);
...
function getComputedSize(attr?: any): any {
    return (
        (typeof attr === 'string') &&
        (attr.slice(-2) === 'px') &&
        parseFloat(attr)
 ...
 */
export function graphJson(gd?: any, dataonly?: any, mode?: any, output?: any, useDefaults?: any, includeConfig?: any): any {
    ...
    function stripObj(d?: any, keepFunction?: any): any {
        ...
        if(isJSDate(d)) return ms2DateTimeLocal(+d);
 ...
 */
export function extendTrace(destTrace?: any, srcTrace?: any): any {
 ...
 * The result is the original object reference with the new contents merged in.
 */
export function extendLayout(destLayout?: any, srcLayout?: any): any {
...
function _transition(gd?: any, transitionOpts?: any, opts?: any): any {
    ...
    function flushCallbacks(list?: any) {
        if(!list) return;
        while(list.length) {
            list.shift();
        }
    ...
    function completeTransition(callback?: any) {
...
export function doCalcdata(gd: GraphDiv, traces?: any): void {
    ...
    function transformCalci(i?: any) {
        ...
        if(trace.visible === true && trace.transforms) {
            ...
            for(j = 0; j < trace.transforms.length; j++) {
                ...
                _module = undefined as any; // transformsRegistry was removed in v3
    ...
    function calci(i?: any, isContainer?: any) {
        trace = fullData[i];
        _module = trace._module;
