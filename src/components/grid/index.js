...
function sizeDefaults(layoutIn, layoutOut) {
    ...
    const isSplomGenerated = (hasXaxes && xAxes !== gridIn.xaxes &&
    ...
    if (hasSubplotGrid) {
        ...
        if (hasYaxes)
            dfltRows = yAxes.length;
        if (hasXaxes)
            dfltColumns = xAxes.length;
    }
