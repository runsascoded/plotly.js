...
export var rangeToShapePosition = function(ax) {
    return (ax.type === 'log') ? ax.r2d : function(v) { return v; };
};

export var shapePositionToRange = function(ax) {
    return (ax.type === 'log') ? ax.d2r : function(v) { return v; };
};

export var decodeDate = function(convertToPx) {
    return function(v) {
...
export var encodeDate = function(convertToDate) {
    return function(v) { return convertToDate(v).replace(' ', '_'); };
};

export var extractPathCoords = function(path, paramsToUse, isRaw) {
...
export var getDataToPixel = function(gd, axis, shift, isVertical, refType) {
...
export var getPixelToData = function(gd, axis, isVertical, opt) {
    var gs = gd._fullLayout._size;
    var pixelToData;
...
export var roundPositionForSharpStrokeRendering = function(pos, strokeWidth) {
...
export var makeShapesOptionsAndPlotinfo = function(gd, index) {
...
export var makeSelectionsOptionsAndPlotinfo = function(gd, index) {
...
export var getPathString = function(gd, options) {
