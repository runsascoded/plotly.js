...
export function plot(gd, cdmodule, transitionOpts, makeOnCompleteCallback) {
...
function plotOne(gd, cd, element, transitionOpts) {
    ...
    sliceData = sliceData.filter((pt) => pt.y1 <= cutoff);
    ...
    updateSlices.each(function (pt) {
        ...
        const strTransform = function (d, textBB) {
...
export function formatSliceLabel(pt, entry, trace, cd, fullLayout) {
    ...
    if (Lib.isValidTextValue(ptTx) || ptTx === '')
        obj.text = ptTx;
