...
export function makeKDE(calcItem, trace, vals) {
...
export function getPositionOnKdePath(calcItem, trace, valuePx) {
    ...
    const pointOnPath = Lib.findPointOnPath(calcItem.path, valuePx, valLetter, { pathLength: calcItem.pathLength });
