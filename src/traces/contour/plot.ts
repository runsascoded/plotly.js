...
export var plot = function plot(gd: GraphDiv,  plotinfo: PlotInfo,  cdcontours,  contourLayer) {
...
export var createLineClip = function(lineContainer,  clipLinesForLabels,  gd: GraphDiv,  uid) {
...
export var labelFormatter = function(gd: GraphDiv,  cd0) {
...
export var calcTextOpts = function(level,  contourFormat,  dummyText,  gd: GraphDiv) {
...
export var drawLabels = function(labelGroup,  labelData,  gd: GraphDiv,  lineClip,  labelClipPathData) {
