...
export default function makeColorMap(trace) {
    ...
    if (contours.coloring === 'heatmap') {
        ...
        const zRangeInput = trace._input && (typeof trace._input.zmin === 'number' && typeof trace._input.zmax === 'number');
    ...
    return Colorscale.makeColorScaleFunc({ domain: domain, range: range }, { noNumericCheck: true });
}
