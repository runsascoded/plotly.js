...
function makePath(pi, loc, edgeflag, xtol, ytol) {
    ...
    const alldists = [];
    let cropstart = 0;
    let distgroup, cnt2, cnt3, newpt, ptcnt, ptavg, thisdist, i, j, edgepathi, edgepathj;
    /*
...
function getInterpPx(pi, loc, step) {
    ...
    if (step[1]) {
        ...
        const dxl = (dx !== 1 ? (1 - dx) * xa.c2l(pi.x[locx]) : 0) +
        ...
        const dyl = (dy !== 1 ? (1 - dy) * ya.c2l(pi.y[locy]) : 0) +
